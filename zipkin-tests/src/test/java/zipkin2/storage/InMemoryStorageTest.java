...
public class InMemoryStorageTest {
    ...
    public void getTraces_filteringMatchesMostRecentTraces() throws IOException {
        ...
        List<Span> earlySpans = IntStream.rangeClosed(1, 10).mapToObj(i -> Span.newBuilder().name("early").traceId(Integer.toHexString(i)).id(Integer.toHexString(i)).timestamp((TODAY - i) * 1000).duration(1L).localEndpoint(endpoints.get(i - 1)).build()).collect(toList());
        List<Span> lateSpans = IntStream.rangeClosed(1, 10).mapToObj(i -> Span.newBuilder().name("late").traceId(Integer.toHexString(i + 10)).id(Integer.toHexString(i + 10)).timestamp((TODAY + gapBetweenSpans - i) * 1000).duration(1L).localEndpoint(endpoints.get(i - 1)).build()).collect(toList());
        ...
        // sanity checks
        assertThat(storage.getTraces(requestBuilder().serviceName("service1").build()).execute()).containsExactly(lateTraces[0], earlyTraces[0]);
        assertThat(storage.getTraces(requestBuilder().build()).execute()).hasSize(20);
        assertThat(storage.getTraces(requestBuilder().limit(10).build()).execute()).containsExactly(lateTraces);
        assertThat(storage.getTraces(requestBuilder().endTs(TODAY + gapBetweenSpans).lookback(gapBetweenSpans).build()).execute()).containsExactly(lateTraces);
        assertThat(storage.getTraces(requestBuilder().endTs(TODAY).build()).execute()).containsExactly(earlyTraces);
    }
     ...
     */
    @Test
    public void differentiatesOnTraceIdWhenTimestampEqual() throws IOException {
        storage.accept(asList(CLIENT_SPAN)).execute();
        storage.accept(asList(CLIENT_SPAN.toBuilder().traceId("333").build())).execute();
        assertThat(storage).extracting("spansByTraceIdTimestamp.delegate").satisfies(map -> assertThat((Map) map).hasSize(2));
    }
    ...
    public static class _Benchmark extends se.chalmers.ju2jmh.api.JU2JmhBenchmark {
        ...
        public void benchmark_getTraces_filteringMatchesMostRecentTraces() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::getTraces_filteringMatchesMostRecentTraces, this.description("getTraces_filteringMatchesMostRecentTraces"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_differentiatesOnTraceIdWhenTimestampEqual() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::differentiatesOnTraceIdWhenTimestampEqual, this.description("differentiatesOnTraceIdWhenTimestampEqual"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_replayOverwrites() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::replayOverwrites, this.description("replayOverwrites"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getSpanNames_skipsNullSpanName() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::getSpanNames_skipsNullSpanName, this.description("getSpanNames_skipsNullSpanName"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getTagsAndThenValues() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::getTagsAndThenValues, this.description("getTagsAndThenValues"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_getTraces_byTraceIds() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::getTraces_byTraceIds, this.description("getTraces_byTraceIds"));
        }

        @org.openjdk.jmh.annotations.Benchmark
        public void benchmark_toStringContainsOnlySummaryInformation() throws java.lang.Throwable {
            this.createImplementation();
            this.runBenchmark(this.implementation()::toStringContainsOnlySummaryInformation, this.description("toStringContainsOnlySummaryInformation"));
        }

        private InMemoryStorageTest implementation;

        @java.lang.Override
        public void createImplementation() throws java.lang.Throwable {
            this.implementation = new InMemoryStorageTest();
        }

        @java.lang.Override
        public InMemoryStorageTest implementation() {
